...
export const centuries: Century[] = [
        ...
        games: [
          {
            ...
            lessons: ["Develop all pieces quickly", "Control the center", "Open files for rooks"],
          ...
          },
          {
            ...
            lessons: ["Queen sacrifice", "Mating patterns", "Piece coordination"],
        ...
        games: [
          {
            ...
            lessons: ["Development over material", "King safety is paramount", "Attack with all pieces"],
          ...
          },
          {
            ...
            lessons: ["Coordinate your pieces", "Sacrifices open lines", "The king hunt"],
        ...
        games: [
          {
            ...
            lessons: ["Preparation meets talent", "Defense can be beautiful", "Endgame technique"],
          ...
          },
          {
            ...
            lessons: ["Queen power in the endgame", "Tactical alertness", "Simplification to winning endgames"],
        ...
        games: [
          {
            ...
            lessons: ["Sometimes sacrifices defy calculation", "Piece coordination", "Pressure leads to mistakes"],
          ...
          },
          {
            ...
            lessons: ["Attacking the king", "Piece sacrifice for initiative", "Using all pieces in attack"],
          ...
          },
          {
            ...
            lessons: ["Intuitive sacrifices", "Calculating complications", "Exploiting uncastled king"],
        ...
        games: [
          {
            ...
            lessons: ["Piece activity over material", "The windmill tactic", "Young talent can beat experience"],
          ...
          },
          {
            ...
            lessons: ["Positional mastery", "Exploiting weak squares", "Converting small advantages"],
          ...
          },
          {
            ...
            lessons: ["Piece coordination", "Tactical alertness", "Exploiting king safety"],
        ...
        games: [
          {
            ...
            lessons: ["Intuition in complex positions", "King hunt", "Spectacular sacrifices can be sound"],
          ...
          },
          {
            ...
            lessons: ["Preparation at the highest level", "Nerves of steel", "Dynamic piece play"],
          ...
          },
          {
            ...
            lessons: ["Human intuition vs calculation", "Endgame technique", "Exploiting computer weaknesses"],
  ...
  },
  {
    ...
    name: "21st Century",
    period: "2000-Present",
    description: "The digital age of chess - computer-aided analysis, online play, and a new generation of super-grandmasters.",
    legends: [
      {
        id: "magnus-carlsen",
        name: "Magnus Carlsen",
        ...
        games: [
          {
            ...
            lessons: ["Converting small advantages", "Endgame technique", "Patience and precision"],
          ...
          },
          {
            ...
            lessons: ["Rook endgame technique", "Creating winning chances from nothing", "The will to win"],
...
export function getAllLegends(): Legend[] {
  return centuries.flatMap(century => century.legends);
}

export function getLegendById(id: string): Legend | undefined {
  return getAllLegends().find(l => l.id === id);
}

export function getGameById(legendId: string, gameId: string): Game | undefined {
  const legend = getLegendById(legendId);
  return legend?.games.find(g => g.id === gameId);
}

export function getCenturyById(id: string): Century | undefined {
  return centuries.find(c => c.id === id);
}

// Keep this for backward compatibility
export const legends = getAllLegends();
